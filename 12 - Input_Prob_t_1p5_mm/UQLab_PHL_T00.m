...
InputOpts.Marginals(4).Moments = (0.0127+0.0015)*[1 0.02];
...
InputOpts.Marginals(7).Moments = (0.009525+0.0015)*[1 0.02];
...
InputOpts.Marginals(10).Moments = (0.009525+0.0015)*[1 0.02];
...
InputOpts.Marginals(13).Moments = (0.015875+0.0015)*[1 0.02];
...
y17=(570.99E3-570.99E3)/(20.657E3);
...
InputOpts.Marginals(18).Moments = [31.97E3 1.156E3];
InputOpts.Marginals(18).Bounds = [1e-5 inf];
y18=(31.97E3-31.97E3)/(1.156E3);
...
AKOptions.AKMCS.MaxAddedED = 600;
