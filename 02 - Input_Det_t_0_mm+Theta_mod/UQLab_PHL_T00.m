...
% InputOpts.Marginals(4).Moments = (0.0127+0.0045)*[1 0.02];
...
% InputOpts.Marginals(7).Moments = (0.009525+0.0045)*[1 0.02];
...
% InputOpts.Marginals(10).Moments = (0.009525+0.0045)*[1 0.02];
...
% InputOpts.Marginals(13).Moments = (0.015875+0.0045)*[1 0.02];
